...
require(ks);require(hypervolume);require(vegan);require(reshape);require(gawdis);require(ape);require(reshape);require(reshape2)
require(gridExtra);require(grid); require(ggplot2); require(lattice); require(dplyr)
...
# trait data
# load your data
data <- read.csv(here ("data","Tabela_R_oficial.csv"), header=TRUE, sep = ",")
...
grid.arrange(kde_period[[1]]$plot +  xlab ("Axis I") + ylab ("Axis II")+ theme(legend.position = "top"),
             ...
             kde_period[[3]]$plot +  xlab ("Axis I") + ylab ("Axis II")+ theme(legend.position = "top"),
             kde_period[[4]]$plot +  xlab ("Axis I") + ylab ("Axis II")+ theme(legend.position = "top"), 
             ncol=1,nrow=4) # 4 plots in the col
